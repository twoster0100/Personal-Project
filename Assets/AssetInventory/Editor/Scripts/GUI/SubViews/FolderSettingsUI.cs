...
namespace AssetInventory
{
    public sealed class FolderSettingsUI : PopupWindowContent
    {
        ...
        private void RenderAssignTag(int width)
        {
            ...
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(UIStyles.Content("Tags", "Tags to assign to each package, separated by comma (e.g. essential,2d)."), EditorStyles.boldLabel, GUILayout.Width(width));
